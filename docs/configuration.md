...
| `allowed_topics` | Array | `["home/#", "sensors/#"]` | Topics the agent can access |
...
| `timezone` | String | `"UTC"` | Timezone for active hours (IANA format, e.g. `America/New_York`, `Europe/London`) |
